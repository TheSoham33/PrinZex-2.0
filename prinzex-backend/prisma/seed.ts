...
async function seedPincodeRegistry(): Promise<void> {
  console.log('… creating the city + pincode registries (delivery geography source of truth)');
  await prisma.city.upsert({
    where: { slug: 'kolkata' },
    update: { name: 'Kolkata', active: true },
    create: { slug: 'kolkata', name: 'Kolkata', active: true },
  });
  for (const entry of PINCODE_REGISTRY) {
    await prisma.pincode.upsert({
      where: { pincode: entry.pincode },
      update: { zoneLabel: entry.zoneLabel },
      create: { pincode: entry.pincode, citySlug: 'kolkata', zoneLabel: entry.zoneLabel, serviceable: true },
    });
  }
}
...
const CUSTOMERS: Array<{
...
}> = [
  {
    ...
    addresses: [
      {
        label: 'Home',
        fullAddress: 'Flat 4B, 17/1 Gariahat Road, Ballygunge',
        city: 'Kolkata',
        state: 'West Bengal',
        pincode: '700019',
        lat: 22.5251,
      ...
      {
        label: 'Office',
        fullAddress: '3rd Floor, Chatterjee House, Park Street',
        city: 'Kolkata',
        state: 'West Bengal',
        pincode: '700016',
        lat: 22.553,
  ...
  },
  {
    ...
    addresses: [
      {
        label: 'Home',
        fullAddress: '212, Southern Avenue, Golpark',
        city: 'Kolkata',
        state: 'West Bengal',
        pincode: '700029',
        lat: 22.5142,
  ...
  },
  {
    ...
    addresses: [
      {
        label: 'Home',
        fullAddress: 'CF-214, Sector 1, Salt Lake',
        city: 'Kolkata',
        state: 'West Bengal',
        pincode: '700064',
        lat: 22.59,
  ...
  },
  {
    ...
    addresses: [
      {
        label: 'Home',
        fullAddress: 'B-1203, Uniworld City, New Town',
        city: 'Kolkata',
        state: 'West Bengal',
        pincode: '700156',
        lat: 22.5935,
  ...
  },
  {
    ...
    addresses: [
      {
        label: 'Home',
        fullAddress: '9/2, NSC Bose Road, Tollygunge',
        city: 'Kolkata',
        state: 'West Bengal',
        pincode: '700040',
        lat: 22.4979,
...
const SELLERS: Array<{
...
}> = [
  {
    ...
    completionRate: 98.5,
    onTimeRate: 96.2,
    servedPincodes: ['700016', '700017', '700071'],
    services: [
  ...
  },
  {
    ...
    phone: '+919110000002',
    gstNumber: '19FGHIJ5678K2Z6',
    businessType: 'Proprietorship',
    storeAddress: '12, Bankim Chatterjee Street, College Square',
    pincode: '700012',
    lat: 22.5744,
    lng: 88.363,
    openingTime: '08:30',
    ...
    completionRate: 97.1,
    onTimeRate: 94.8,
    servedPincodes: ['700012', '700009', '700006'],
    services: [
  ...
  },
  {
    ...
    phone: '+919110000003',
    gstNumber: '19KLMNO9012P3Z7',
    businessType: 'Partnership',
    storeAddress: 'DN Block, Sector V, Salt Lake',
    pincode: '700091',
    lat: 22.5797,
    lng: 88.4337,
    openingTime: '10:00',
    ...
    completionRate: 99.0,
    onTimeRate: 97.5,
    servedPincodes: ['700091', '700064', '700098'],
    services: [
  ...
  },
  {
    ...
    phone: '+919110000004',
    gstNumber: '19PQRST3456Q4Z8',
    businessType: 'Proprietorship',
    storeAddress: 'Raja S.C. Mullick Road, Near Jadavpur University',
    pincode: '700032',
    lat: 22.4979,
    lng: 88.3714,
    openingTime: '09:00',
...
const DELIVERY_BOYS: Array<{
...
}> = [
  {
    ...
    vehicleType: 'bike',
    vehicleRegNo: 'WB01AB1234',
    licenseNumber: 'WB0120220012345',
    isOnline: true,
    currentLat: 22.5645,
    currentLng: 88.3523,
    averageRating: 4.7,
  ...
  },
  {
    ...
    vehicleType: 'scooter',
    vehicleRegNo: 'WB05CD5678',
    licenseNumber: 'WB0520210054321',
    isOnline: true,
    currentLat: 22.5135,
    currentLng: 88.402,
    averageRating: 4.4,
  ...
  },
  {
    ...
    vehicleType: 'bike',
    vehicleRegNo: 'WB03EF9012',
    licenseNumber: 'WB0320230098765',
    isOnline: false,
    currentLat: 22.5186,
    currentLng: 88.3654,
    averageRating: 4.9,
