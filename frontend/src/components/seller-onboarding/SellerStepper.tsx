...
const STEPS = ['Store info', 'Services', 'Pricing', 'Bank details', 'Documents'];
...
export default function SellerStepper({ current, maxReached, onStepClick }: SellerStepperProps) {
  return (
          ...
          return (
            <li key={label} className="flex flex-1 items-center last:flex-none">
              ...
              >
                ...
                <span
                  className={`hidden whitespace-nowrap text-sm font-medium lg:block ${
