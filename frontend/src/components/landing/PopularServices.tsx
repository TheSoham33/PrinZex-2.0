...
const SERVICES = [
  ...
  { icon: IconIdCard, name: 'Business cards', hint: 'From ₹3/pc', query: 'business cards', color: 'bg-violet-50 text-violet-600' },
  { icon: IconFlag, name: 'Banners', hint: 'From ₹45/sq ft', query: 'banners', color: 'bg-orange-50 text-orange-600' },
  { icon: IconImageIcon, name: 'Photo prints', hint: 'From ₹25/pc', query: 'photo prints', color: 'bg-rose-50 text-rose-600' },
  { icon: IconTag, name: 'Stickers', hint: 'From ₹4/pc', query: 'stickers', color: 'bg-emerald-50 text-emerald-600' },
