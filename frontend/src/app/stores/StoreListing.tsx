...
export default function StoreListing() {
  ...
  // Storefront city picker (multi-city): free-text search wins over the pick.
  const city = useCity();
  ...
  const { data, isLoading, isError } = useQuery({
    ...
    queryKey: ['stores', location, query, filters, page, userLat, userLng, city.slug],
    queryFn: () => fetchStores({
          ...
          <p className="mt-0.5 flex items-center gap-1.5 text-xs text-slate-500">
            ...
            {locationSource === 'geolocation'
              ...
              : locationSource === 'remembered'
                ...
                : `Showing distances from ${city.name} — location unavailable`}
